...
```bash
https://github.com/CJ7MO/Kidney-Disease-Classification-Deep-Learning-Project
```
...
## 3. Create ECR repo to store/save docker image
    - Save the URI: 110572733024.dkr.ecr.us-east-2.amazonaws.com/kidneycls
...
# 7. Setup github secrets:
    ...
    AWS_ECR_LOGIN_URI = demo>>  110572733024.dkr.ecr.us-east-2.amazonaws.com/kidneycls

    ECR_REPOSITORY_NAME = kidneycls